...
<div class="highlight highlight-source-shell"><pre>Raspberry Pi (v3)<pre>RPi (v2.1) 8MP camera</pre><pre>LidarLite (v3) LIDAR rangefinder</pre><pre>Adafruit Ultimate GPS</pre><pre>HDMI screen (800x480)</pre><pre>Custom built HAT w/ power loss GPIO and capacitors to delay power off</pre><</pre></div>
...
<div class="highlight highlight-source-shell"><pre>OpenCv 3.1.0<p>Raspicam 0.1.3</p><p>WiringPi 2.29</p></pre></div>
