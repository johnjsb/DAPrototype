...
<div class="highlight highlight-source-shell"><pre>Raspberry Pi (v3)<span class="pl-c1">RPi (v2.1) 8MP camera</span><span class="pl-c1">LidarLite (v3) LIDAR rangefinder</span><span class="pl-c1">Adafruit Ultimate GPS</span><span class="pl-c1">HDMI screen (800x480)</span><span class="pl-c1">Custom built HAT w/ power loss GPIO and capacitors to delay power off</span><</pre></div>
...
<div class="highlight highlight-source-shell"><pre>OpenCv 3.1.0<span class="pl-c1">Raspicam 0.1.3</span><span class="pl-c1">WiringPi 2.29</span></pre></div>
