...
<div class="highlight highlight-source-shell"><pre>Raspberry Pi (v3)<p>RPi (v2.1) 8MP camera</p><p>LidarLite (v3) LIDAR rangefinder</p><p>Adafruit Ultimate GPS</p><p>HDMI screen (800x480)</p><p>Custom built HAT w/ power loss GPIO and capacitors to delay power off</p><</pre></div>
